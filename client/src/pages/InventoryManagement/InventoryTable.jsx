...
function InventoryTable() {
    ...
    const handleSearch = (e) => {
        ...
        const filtered = data?.inventory?.filter(elem => {
            ...
            const quantityMatch = elem.quantity.toString().includes(searchQuery);
                ...
                <tbody>
                    {searchResults?.map((elem, index) => {
                        ...
                        <tr key={index} className="bg-paleblue">
                            ...
                            <td className="border-b-2 border-b-blue px-4 py-2">{elem.price}</td>
                            <td className="border-b-2 border-b-blue px-4 py-2">{elem.quantity}</td>
                            <td className="border-b-2 border-b-blue px-4 py-2">{elem.supplier}</td>
