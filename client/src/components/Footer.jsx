        ...
        <div className="container max-w-7xl py-10">
            <div className="grid md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="">
                    ...
                    <p className="mb-6 list-none">0115755999</p>
                    <h5 className="mb-2 font-bold">Email</h5>
                    <p className="mb-0 list-none">Egas.lk</p>
                </div>
                <div className="">
                    <h5 className="mb-2 font-bold">E GAS</h5>
                    <p className="mb-6 list-none">140/2, Kandy Road, Malabe.</p>
                </div>
                <div className="">
                    ...
                    <h5 className="mb-2 font-bold">We Deliver Arround Malabe and Kaduwela</h5>
                    <p className="mb-6 list-none">Delivery with in 24hrs </p>
                </div>
            </div>
        </div>
        <div className="w-full bg-blue p-4 text-center">© Egas.lk : All Rights Reserved.</div>
    </footer>
</div>
  )
}
