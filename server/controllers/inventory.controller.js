...
const addInventoryItem = async (req, res) => {
    try {
        const {name, price, quantity, expirAt, manuAt, storageCondition, type,supplier,imageUrl,status} = req.body
        
        const newInventory = new Inventory({
            name, price, quantity, expirAt, manuAt, storageCondition, type,supplier,imageUrl,status
        })
